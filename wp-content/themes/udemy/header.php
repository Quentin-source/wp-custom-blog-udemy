...
<html<?php language_attributes(); ?>>
    ...
    <body class="stretched no-transition" <?php body_class(); ?>>
          ...
          ============================================= -->
                        <div id="top-social">
                            <ul>
                                ...
                                ?>
                                    <li>
                                        <a href="https://instagram.com/<?php echo get_theme_mod("ju_twitter_handle") ?>" class="si-instagram">
    ...
    ============================================= -->
        ...
        ============================================= -->
                    <div id="logo">
                        ...
                        if (has_custom_logo()) {
                            the_custom_logo();
                        } else { ?><a href="<?php echo home_url("/") ?>" class="standard-logo"><?php bloginfo("name") ?></a>
                        <?php } ?>
                    </div><!-- #logo end -->
                        ...
                        ============================================= -->
                                ...
                                <div id="top-search">
                                    ...
                                    <form action="<?php echo esc_url(home_url('/')); ?>" method="get">
                                        <input type="text" name="q" class="form-control" placeholder="<?php _e("Search", 'wp-custom-blog-udemy'); ?>" value="<?php the_search_query(); ?>">
                                    </form>
                                </div><!-- #top-search end -->
